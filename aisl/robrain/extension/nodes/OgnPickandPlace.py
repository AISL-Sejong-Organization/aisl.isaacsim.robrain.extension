...
class OgnPickandPlace:
    ...
    def compute(db) -> bool:
        ...
        try:
            ...
            current_target_object_ori = db.inputs.grasp_point_ori
            cur_target_object_pos = db.inputs.grasp_point_pos
            ...
            object_target_ori = db.inputs.place_point_ori
            object_target_pos = db.inputs.place_point_pos
            ...
            if state.task == "Idle":
                ...
                print(f"Robot DOF names: {robot_dof_names}")
                target_dof_names = [
                    "joint_1",
                    "joint_2",
                    "joint_3",
