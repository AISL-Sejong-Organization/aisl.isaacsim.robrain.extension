...
class AislRobrainExtensionExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[aisl.robrain.extension] AislRobrainExtensionExtension startup", flush=True)

    def on_shutdown(self):
        print("[aisl.robrain.extension] AislRobrainExtensionExtension shutdown", flush=True)
